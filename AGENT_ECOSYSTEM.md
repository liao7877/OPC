...
**子 Agent（派活/调用）默认继承父会话工作区**：总管在 `E0000-AI员工-总管/` 工作区开子 Agent 派活给 E0001 → 子 Agent 扫的是 `E0000-AI员工-总管/.workbuddy/skills`（总管级），**不会自动切到 E0001-AI员工-售前工程师 目录披露 E0001 私有技能**。
