...
- **知识库（2026-08-30 决策 #19，依据 PRINCIPLES P33）**：本目录 `knowledge/` = 你的**员工级知识库（可写）**；团队级与公司级对你**只读**。
  ...
  - **团队级知识库（你是 T001 lead）**：`opc://company:C001/team/T001/knowledge/` 由**你管**——成员向你发起上浮，你审批（同样两条准入 + 审批前查重）；执行 `python opc_model.py --promote <条目> --to team:T001 --actor E0002`。
